...
HD_PWD='C:/Users/brandon.hahn/ee324_game_vivado_school_computer/ee324_game_vivado_school_computer.runs/brandonBlockDesign_hdmi_tx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log brandonBlockDesign_hdmi_tx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source brandonBlockDesign_hdmi_tx_0_0.tcl
