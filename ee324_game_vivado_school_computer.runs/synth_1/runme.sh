...
HD_PWD='C:/Users/brandon.hahn/ee324_game_vivado_school_computer/ee324_game_vivado_school_computer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log brandonBlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source brandonBlockDesign_wrapper.tcl
