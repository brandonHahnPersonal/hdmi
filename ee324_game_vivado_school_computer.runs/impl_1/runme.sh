...
HD_PWD='C:/Users/brandon.hahn/ee324_game_vivado_school_computer/ee324_game_vivado_school_computer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log brandonBlockDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source brandonBlockDesign_wrapper.tcl -notrace
